...
family, as argued eg. by \textcite{grollemund2015bantu,ehret2015bantu}.
\emph{So, how could I add these effects to my model, or why do I not need to?}

However, diverging
% I should not use the word ‘crackpot’ here.
hypotheses notwithstanding \parencite{tone-humidity,elevation-ejectives,etc}, it
seems that a vast number of cultural traits are not adaptive for human survival
\parencite{}. This does not exclude individual traits exhibiting non-neutral
evolutionary dynamics, as shown eg. by \textcite{kandler2013non}. But a (largely, with exceptions as mentioned above) neutral model for
cultural change appears appropriate nonetheless.
...
TO BE READ:
(Fogarty et al. 2015a; Mesoudi
2011).
Strimling et al. (2009) and Fogarty et al. (2015b),
which assume M = ∞
(Milke 1949; Murdock 1957; Smith and
Crano 1977; Cook and Szumal 1993; Mace and Pagel 1994). In general, cultural traits
have been defined as the minimal unit of cultural transmission (Naroll 1964;
Pocklington and Best 1997; Borgerhoff-Mulder et al. 2006; Lyman and O’Brien
2003; O’Brien et al. 2010). In that sense, they represent any measurable unit that we
can delineate within the observed social variation and that can be argued have inher-
itance continuity (Eerkens and Lipo 2005). Among certain scholars, there is a tendency
to call memes to such minimal units of ideas, symbols, values, or practices transmitted
from agent to agent on occasion of an interaction act (Dawkins 1976).
...
implementation (see \cref{s:agents} for some reasons why we can), we take this
